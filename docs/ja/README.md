...
そうでない場合は、拡張された [ユーザーガイド](https://github.com/KudoAI/chatgpt.js/blob/v2.7.0/docs/USERGUIDE.md) を確認するか、単に [問題](https://github.com/KudoAI/chatgpt.js/issues) または [PR](https://github.com/KudoAI/chatgpt.js/pulls) と統合されるので、簡単です!
...
[ユーザーガイド](https://github.com/KudoAI/chatgpt.js/blob/v2.7.0/docs/USERGUIDE.md) / 
