...
![](https://img.shields.io/github/size/kudoai/chatgpt.js/dist/chatgpt-2.1.1.min.js?label=縮小サイズ&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge)
[![](https://img.shields.io/codefactor/grade/github/kudoai/chatgpt.js?label=コードの品質&logo=codefactor&logoColor=white&labelColor=464646&color=29c3c5&style=for-the-badge)](https://www.codefactor.io/repository/github/kudoai/chatgpt.js)
...
📣 _あなたは OSS サポーターですか? JavaScript は好きですか? それなら、AI アプリ開発の将来に貢献してみませんか? **chatgpt.js** はまさにこの目的のために協力者を募集しています。 [ディスカッション](https://github.com/KudoAI/chatgpt.js/Discussions/new?category=ideas) または [プル リクエスト](https://github.com/KudoAI/chatgpt.js/pulls) を開くだけです (**任意**のサイズのアイデアは大歓迎です) または、[ロードマップ](https://github.com/orgs/KudoAI/projects/1) をチェックして、貢献できるものを探してください!_
