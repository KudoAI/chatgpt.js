...
<a href="#">
    <img src="https://img.shields.io/badge/jsDelivr_%E3%83%AA%E3%82%AF%E3%82%A8%E3%82%B9%E3%83%88-4,140,445+-2bbbd8.svg?logo=jsdelivr&logoColor=white&labelColor=464646&style=for-the-badge"></a>
...
（任意）[.chatgpt.config.mjs](https://github.com/KudoAI/chatgpt.js/blob/main/.chatgpt.config.mjs) を作成し、プロバイダーなどをカスタマイズします：

```bash
chatgpt init  # または gpt -i
```

すべての CLI オプションを表示します：
...
[ユーザーガイド](https://github.com/KudoAI/chatgpt.js/blob/v4.15.1/docs/USERGUIDE.md) /
