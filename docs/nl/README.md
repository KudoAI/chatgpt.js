...
[![](https://img.shields.io/badge/Geïncubeerd_door-100.builders-9146ff?logo=gamejolt&logoColor=white&labelColor=464646&style=for-the-badge)](https://app.100.builders/directory)
...
📣 _Ben jij een OSS-supporter? Ben je dol op JavaScript? Waarom zou u dan niet bijdragen aan de toekomst van de ontwikkeling van AI-apps? **chatgpt.js** zoekt medewerkers voor precies dit doel! Open gewoon een [discussie](https://github.com/KudoAI/chatgpt.js/discussions/new?category=ideas) of [pull request](https://github.com/KudoAI/chatgpt.js/pulls) (ideeën van **elke** grootte zijn welkom) of bekijk onze [openbare roadmap](https://github.com/orgs/KudoAI/projects/1) voor iets om aan bij te dragen!_
