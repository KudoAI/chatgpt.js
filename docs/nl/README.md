...
![](https://img.shields.io/badge/Klonen-2K/maand-869da0?logo=github&logoColor=white&labelColor=464646&style=for-the-badge)
...
Als dit niet het geval is, bekijk dan de uitgebreide [gebruikershandleiding](https://github.com/KudoAI/chatgpt.js/blob/v2.9.3/docs/USERGUIDE.md), of dien gewoon een [probleem](https://github.com/KudoAI/chatgpt.js/issues) in of [PR](https://github.com/KudoAI/chatgpt.js/pulls) en het wordt geïntegreerd, makkelijk!
...
> Voegt AI-antwoorden toe aan Brave Search. Vraag het vanaf elke site. Mogelijk gemaakt door GPT-4o!
...
> Voegt AI-antwoorden toe aan DuckDuckGo. Vraag het vanaf elke site. Mogelijk gemaakt door GPT-4o!
...
> Voegt AI-antwoorden toe aan Google Zoeken. Vraag het vanaf elke site. Mogelijk gemaakt door Google Gemma + GPT-4o!
...
[gebruikershandleiding](https://github.com/KudoAI/chatgpt.js/blob/v2.9.3/docs/USERGUIDE.md) /
