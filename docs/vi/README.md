...
![](https://img.shields.io/github/size/kudoai/chatgpt.js/dist/chatgpt-2.1.1.min.js?label=Kích+Thước+Tối+Thiểu&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge)
[![](https://img.shields.io/codefactor/grade/github/kudoai/chatgpt.js?label=Chất+Lượng+Mã&logo=codefactor&logoColor=white&labelColor=464646&color=29c3c5&style=for-the-badge)](https://www.codefactor.io/repository/github/kudoai/chatgpt.js)
...
📣 _Bạn có phải là người hỗ trợ OSS không? Bạn có thích JavaScript không? Vậy thì tại sao không đóng góp cho tương lai phát triển ứng dụng AI? **chatgpt.js** đang tìm cộng tác viên cho chính mục đích này! Chỉ cần mở [thảo luận](https://github.com/KudoAI/chatgpt.js/discussions/new?category=ideas) hoặc [pull request](https://github.com/KudoAI/chatgpt.js/pulls ) (ý tưởng về kích thước **bất kỳ** nào đều được hoan nghênh) hoặc xem [lộ trình](https://github.com/orgs/KudoAI/projects/1) của chúng tôi để biết nội dung nào đó có thể đóng góp!_
...
```js
...
// @require https://cdn.jsdelivr.net/gh/kudoai/chatgpt.js@150f64ec879ebd75dee4625bb9208a9ebf32f19e/dist/chatgpt-2.1.1.min.js
// ==/UserScript==
