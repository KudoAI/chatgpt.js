...
![](https://img.shields.io/badge/Bản_sao-2K/tháng-869da0?logo=github&logoColor=white&labelColor=464646&style=for-the-badge)
[![](https://img.shields.io/github/size/KudoAI/chatgpt.js/dist/chatgpt.min.js?branch=v2.9.3&label=Kích+thước+thu+nhỏ&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge)](https://github.com/KudoAI/chatgpt.js/tree/v2.9.3/dist/chatgpt.min.js)
...
Nếu không, hãy xem [hướng dẫn sử dụng](https://github.com/KudoAI/chatgpt.js/blob/v2.9.3/docs/USERGUIDE.md) mở rộng hoặc chỉ cần gửi [vấn đề](https://github.com/KudoAI/chatgpt.js/issues) hoặc [PR](https://github.com/KudoAI/chatgpt.js/pulls) và nó sẽ được tích hợp, thật dễ dàng!
...
> Thêm câu trả lời AI vào Brave Search. Hỏi từ bất kỳ trang web nào. Được hỗ trợ bởi GPT-4o!
...
> Thêm câu trả lời AI vào DuckDuckGo. Hỏi từ bất kỳ trang web nào. Được hỗ trợ bởi GPT-4o!
...
> Thêm câu trả lời AI vào Google Tìm kiếm. Hỏi từ bất kỳ trang web nào. Được cung cấp bởi Google Gemma + GPT-4o!
...
[Hướng dẫn sử dụng](https://github.com/KudoAI/chatgpt.js/blob/v2.9.3/docs/USERGUIDE.md) /
