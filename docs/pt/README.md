...
<a href="https://github.com/KudoAI/chatgpt.js/tree/v3.8.1/dist/chatgpt.min.js" target="_blank" rel="noopener">
    <img src="https://img.shields.io/github/size/KudoAI/chatgpt.js/dist/chatgpt.min.js?branch=v3.8.1&label=Tamanho%20reduzido&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge"></a>
...
Caso contrário, verifique o [guia do usuário](https://github.com/KudoAI/chatgpt.js/blob/v3.8.1/docs/USERGUIDE.md) estendido  ou simplesmente envie um [problema](https://github.com/KudoAI/chatgpt.js/issues) ou [PR](https://github.com/KudoAI/chatgpt.js/pulls) e será integrado, mole-mole!
...
[guia do usuário](https://github.com/KudoAI/chatgpt.js/blob/v3.8.1/docs/USERGUIDE.md) /
