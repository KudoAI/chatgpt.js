...
![](https://img.shields.io/github/size/kudoai/chatgpt.js/dist/chatgpt-2.1.1.min.js?label=Tamanho+Reduzido&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge)
[![](https://img.shields.io/codefactor/grade/github/kudoai/chatgpt.js?label=Qualidade+do+Código&logo=codefactor&logoColor=white&labelColor=464646&color=29c3c5&style=for-the-badge)](https://www.codefactor.io/repository/github/kudoai/chatgpt.js)
...
📣 _Você é um apoiador do OSS? Você ama JavaScript? Então, por que não contribuir para o futuro do desenvolvimento de aplicativos AI? **chatgpt.js** procura colaboradores precisamente para esta causa! Basta abrir uma [discussão](https://github.com/KudoAI/chatgpt.js/discussions/new?category=ideas) ou [pull request](https://github.com/KudoAI/chatgpt.js/pulls) (idéias de **qualquer** tamanho são bem-vindas) ou confira nosso [roteiro](https://github.com/orgs/KudoAI/projects/1) para algo com que contribuir!_
...
**[Lançamentos](https://github.com/kudoai/chatgpt.js/tree/main/dist)** /
