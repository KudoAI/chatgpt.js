...
Si no fue así, consulte la [guía del usuario](https://github.com/KudoAI/chatgpt.js/blob/v3.7.0/docs/USERGUIDE.md) extendida, o simplemente envíe un [problema] (https:/ /github.com/KudoAI/chatgpt.js/issues) o [PR](https://github.com/KudoAI/chatgpt.js/pulls) y se integrará, ¡pan comido!
...
[Guía del usuario](https://github.com/KudoAI/chatgpt.js/blob/v3.7.0/docs/USERGUIDE.md) /
