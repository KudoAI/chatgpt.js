...
![](https://img.shields.io/badge/Solicitudes_jsDelivr-1,500,000+-2bbbd8.svg?logo=jsdelivr&logoColor=white&labelColor=464646&style=for-the-badge)
...
Si no fue así, consulte la [guía del usuario](https://github.com/KudoAI/chatgpt.js/blob/v2.9.2/docs/USERGUIDE.md) extendida, o simplemente envíe un [problema] (https:/ /github.com/KudoAI/chatgpt.js/issues) o [PR](https://github.com/KudoAI/chatgpt.js/pulls) y se integrará, ¡pan comido!
...
> Muestre las respuestas de ChatGPT en la barra lateral de Google Search (¡con tecnología de GPT-4!)
...
[Guía del usuario](https://github.com/KudoAI/chatgpt.js/blob/v2.9.2/docs/USERGUIDE.md) /
