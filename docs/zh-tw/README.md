...
<a href="https://www.codefactor.io/repository/github/kudoai/chatgpt.js">
    <img src="https://img.shields.io/codefactor/grade/github/kudoai/chatgpt.js?label=%E4%BB%A3%E7%A2%BC%E8%B3%AA%E9%87%8F&logo=codefactor&logoColor=white&labelColor=464646&color=a0fc55&style=for-the-badge"></a>
...
<a href="#">
    <img src="https://img.shields.io/badge/jsDelivr_請求-4,140,445+-2bbbd8.svg?logo=jsdelivr&logoColor=white&labelColor=464646&style=for-the-badge"></a>
</div>
...
1. 將 https://cdn.jsdelivr.net/npm/@kudoai/chatgpt.js@4/dist/chatgpt.min.js 儲存到 `lib` 目錄。

2. 在專案（V3）的 `manifest.json` 檔案中，將 `lib/chatgpt.min.js` 新增為可存取的 Web 資源。
...
chatgpt --commit-msg  # 或者 gpt -g (在 git 倉庫中)
...
<details>
    <summary>
        為亞馬遜購物添加 AI 聊天和產品/類別摘要，由最新的 LLM 提供支援！
    </summary>
    <br>
    <blockquote>
...
<details>
    <summary>
        自動清除您的 ChatGPT 查詢歷史記錄，以最大程度地保護您的隱私。
    </summary>
    <br>
    <blockquote>
...
<details>
    <summary>
        為 Brave Search 添加 AI 聊天和搜尋摘要，由最新的 LLM 提供支援！
    </summary>
    <br>
    <blockquote>
...
<details>
    <summary>
        無所不知的 ChatGPT 可以產生無窮無盡的答案（任何主題！）
    </summary>
    <br>
    <blockquote>
...
<details>
    <summary>
        增強 ChatGPT 的寬螢幕/全螢幕/垂直螢幕模式以及垃圾訊息攔截功能。也適用於 poe.com！
    </summary>
    <br>
    <blockquote>
...
<details>
    <summary>
        為 DuckDuckGo 添加 AI 聊天和搜尋摘要，由最新的 LLM 提供支援！
    </summary>
    <br>
    <blockquote>
...
<details>
    <summary>
        為 Google 搜尋新增 AI 聊天和搜尋摘要功能，由最新的 LLM 提供支援！
    </summary>
    <br>
    <blockquote>
...
[用戶指南](https://github.com/KudoAI/chatgpt.js/blob/v4.15.1/docs/USERGUIDE.md) /
