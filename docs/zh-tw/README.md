...
<a href="https://trendshift.io/repositories/2896">
    <img src="https://img.shields.io/badge/GitHub_Repos-%E6%9B%BE%E7%99%BB_Top_20_%E8%B6%A8%E5%8B%A2-869da0?logo=github&logoColor=white&labelColor=464646&style=for-the-badge"></a>
<a href="#">
...
<div align="center">
    ...
    <h3><a href="https://www.warp.dev/chatgptjs" target="_blank">
        Warp，存在於你的終端機中的 AI Devtool</h3>
    <a href="https://www.warp.dev/chatgptjs" target="_blank">
        適用於 MacOS、Linux 和 Windows</a>
</div>
...
如果沒有，請查看擴展的[用戶指南](https://github.com/KudoAI/chatgpt.js/blob/v3.7.1/docs/USERGUIDE.md)，或者只需提交一個[問題](https://github.com/KudoAI/chatgpt.js/issues) 或 [PR](https://github.com/KudoAI/chatgpt.js/pulls) 它將被集成，簡單易行！
...
[用戶指南](https://github.com/KudoAI/chatgpt.js/blob/v3.7.1/docs/USERGUIDE.md) /
