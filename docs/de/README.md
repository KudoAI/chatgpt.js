...
![](https://img.shields.io/github/size/kudoai/chatgpt.js/dist/chatgpt-2.1.0.min.js?label=Minimierte+Größe&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge)
...
📣 _Sind Sie ein OSS-Unterstützer? Liebst du JavaScript? Warum tragen Sie dann nicht zur Zukunft der ChatGPT-App-Entwicklung bei? **chatgpt.js** sucht Mitarbeiter für genau diesen Zweck! Öffnen Sie einfach eine [Diskussion](https://github.com/KudoAI/chatgpt.js/discussions/new?category=ideas) oder eine [Pull-Anfrage](https://github.com/KudoAI/chatgpt.js/pulls) (ideen jeder Größe sind willkommen!)_
