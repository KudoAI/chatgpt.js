...
![](https://img.shields.io/badge/Cloner-2K/mois-869da0?logo=github&logoColor=white&labelColor=464646&style=for-the-badge)
...
Si ce n'est pas le cas, consultez le [guide de l'utilisateur](https://github.com/KudoAI/chatgpt.js/blob/v2.9.3/docs/USERGUIDE.md) étendu, ou soumettez simplement un [problème](https://github.com/KudoAI/chatgpt.js/issues) ou [PR](https://github.com/KudoAI/chatgpt.js/pulls) et il sera intégré, très facile!
...
> Ajoute des réponses IA à Brave Search. Demandez sur n’importe quel site. Propulsé par GPT-4o!
...
> Ajoute des réponses IA à DuckDuckGo. Demandez sur n’importe quel site. Propulsé par GPT-4o!
...
> Ajoute des réponses IA à la recherche Google. Demandez sur n’importe quel site. Propulsé par Google Gemma + GPT-4o!
...
[Guide de l'utilisateur](https://github.com/KudoAI/chatgpt.js/blob/v2.9.3/docs/USERGUIDE.md) /
