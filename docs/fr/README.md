...
![](https://img.shields.io/github/size/kudoai/chatgpt.js/dist/chatgpt-2.1.0.min.js?label=Taille+Minimisée&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge)
...
📣 _Êtes-vous un supporter de l'OSS? Aimez-vous Javascript? Alors pourquoi ne pas contribuer à l'avenir du développement d'applications ChatGPT? **chatgpt.js** recherche des collaborateurs pour exactement cette cause! Ouvrez simplement une [discussion](https://github.com/KudoAI/chatgpt.js/discussions/new?category=ideas) ou [pull request](https://github.com/KudoAI/chatgpt.js/pulls) (les idées de **toutes** tailles sont les bienvenues!)_
