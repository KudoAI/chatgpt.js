...
<a href="https://github.com/KudoAI/chatgpt.js/tree/v3.8.1/dist/chatgpt.min.js" target="_blank" rel="noopener">
    <img src="https://img.shields.io/github/size/KudoAI/chatgpt.js/dist/chatgpt.min.js?branch=v3.8.1&label=Taille%20minimis%C3%A9e&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge"></a>
...
<a href="https://trendshift.io/repositories/2896" target="_blank" rel="noopener">
    <img src="https://img.shields.io/badge/GitHub-%C3%89tait_Top_20-869da0?logo=github&logoColor=white&labelColor=464646&style=for-the-badge"></a>
<a href="#">
    ...
    <div id="creatives">
        <div id="warp">
            ...
            <h3><a href="https://www.warp.dev/chatgptjs" target="_blank" rel="noopener">
                Warp, l'outil de développement d'IA intégré à votre terminal</a></h3>
            <i><a href="https://www.warp.dev/chatgptjs" target="_blank" rel="noopener">
                Disponible pour macOS, Linux et Windows</a></i>
        </div>
    </div>
    <br><br><br>
</div>
...
Si ce n'est pas le cas, consultez le [guide de l'utilisateur](https://github.com/KudoAI/chatgpt.js/blob/v3.8.1/docs/USERGUIDE.md) étendu, ou soumettez simplement un [problème](https://github.com/KudoAI/chatgpt.js/issues) ou [PR](https://github.com/KudoAI/chatgpt.js/pulls) et il sera intégré, très facile!
...
[Guide de l'utilisateur](https://github.com/KudoAI/chatgpt.js/blob/v3.8.1/docs/USERGUIDE.md) /
