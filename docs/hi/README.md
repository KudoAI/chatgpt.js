...
![](https://img.shields.io/github/size/kudoai/chatgpt.js/dist/chatgpt-2.1.1.min.js?label=Minified%20Size&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge)
...
[![](https://img.shields.io/badge/Incubated_by-100.builders-9146ff?logo=gamejolt&logoColor=white&labelColor=464646&style=for-the-badge)](https://app.100.builders)
...
📣 _क्या आप ओएसएस समर्थक हैं? क्या आपको जावास्क्रिप्ट पसंद है? तो फिर चैटजीपीटी ऐप विकास के भविष्य में योगदान क्यों न दें? **chatgpt.js** बिल्कुल इसी उद्देश्य के लिए सहयोगियों की तलाश कर रहा है! बस एक [चर्चा](https://github.com/KudoAI/chatgpt.js/discussions/new?category=ideas) या [पुल अनुरोध](https://github.com/KudoAI/chatgpt.js/pulls) खोलें (**किसी भी** आकार के विचारों का स्वागत है) या किसी योगदान के लिए हमारा [रोडमैप](https://github.com/orgs/KudoAI/projects/1) देखें!_
