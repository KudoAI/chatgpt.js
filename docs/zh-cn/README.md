...
![](https://img.shields.io/badge/克隆-638/月-869da0?logo=github&logoColor=white&labelColor=464646&style=for-the-badge)
...
如果没有，请查看扩展的[用户指南](https://github.com/KudoAI/chatgpt.js/blob/v3.2.1/docs/USERGUIDE.md)，或者只需提交一个[问题](https://github.com/KudoAI/chatgpt.js/issues) 或 [PR](https://github.com/KudoAI/chatgpt.js/pulls) 它将被集成，简单易行！
...
[用户指南](https://github.com/KudoAI/chatgpt.js/blob/v3.2.1/docs/USERGUIDE.md) / 
