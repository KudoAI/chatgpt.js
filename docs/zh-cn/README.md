...
如果没有，请查看扩展的[用户指南](https://github.com/KudoAI/chatgpt.js/blob/v3.3.5/docs/USERGUIDE.md)，或者只需提交一个[问题](https://github.com/KudoAI/chatgpt.js/issues) 或 [PR](https://github.com/KudoAI/chatgpt.js/pulls) 它将被集成，简单易行！
