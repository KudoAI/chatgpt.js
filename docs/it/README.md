...
![](https://img.shields.io/badge/Cloni-2K/mese-869da0?logo=github&logoColor=white&labelColor=464646&style=for-the-badge)
...
In caso contrario, consulta la [guida per l'utente](https://github.com/KudoAI/chatgpt.js/blob/v2.9.3/docs/USERGUIDE.md) estesa o invia semplicemente un [problema](https://github.com/KudoAI/chatgpt.js/issues) o [PR](https://github.com/KudoAI/chatgpt.js/pulls) e sarà integrato, facile!
...
> Mostra le risposte di ChatGPT nella barra laterale di Brave Search (basato su GPT-4o!)
...
> Visualizza le risposte di ChatGPT nella barra laterale di DuckDuckGo (basato su GPT-4o!)
...
> Visualizza le risposte di ChatGPT nella barra laterale di Google Search (basato su GPT-4o + Google Gemma!)
...
[Guida per l'utente](https://github.com/KudoAI/chatgpt.js/blob/v2.9.3/docs/USERGUIDE.md) /
