...
<a href="https://github.com/KudoAI/chatgpt.js/tree/v3.8.3/dist/chatgpt.min.js" target="_blank" rel="noopener">
    <img src="https://img.shields.io/github/size/KudoAI/chatgpt.js/dist/chatgpt.min.js?branch=v3.8.3&label=Dimensioni%20ridotte&logo=databricks&logoColor=white&labelColor=464646&color=ff69b4&style=for-the-badge"></a>
...
In caso contrario, consulta la [guida per l'utente](https://github.com/KudoAI/chatgpt.js/blob/v3.8.3/docs/USERGUIDE.md) estesa o invia semplicemente un [problema](https://github.com/KudoAI/chatgpt.js/issues) o [PR](https://github.com/KudoAI/chatgpt.js/pulls) e sarà integrato, facile!
...
[Guida per l'utente](https://github.com/KudoAI/chatgpt.js/blob/v3.8.3/docs/USERGUIDE.md) /
