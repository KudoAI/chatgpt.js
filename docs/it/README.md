...
In caso contrario, consulta la [guida per l'utente](https://github.com/KudoAI/chatgpt.js/blob/v2.9.1/docs/USERGUIDE.md) estesa o invia semplicemente un [problema](https://github.com/KudoAI/chatgpt.js/issues) o [PR](https://github.com/KudoAI/chatgpt.js/pulls) e sarà integrato, facile!
...
[Guida per l'utente](https://github.com/KudoAI/chatgpt.js/blob/v2.9.1/docs/USERGUIDE.md) /
