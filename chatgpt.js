...
var chatgpt = {
  ...
  response: {
    ...
    regenerate: function () {
      var formButton = chatgpt.getRegenerateButton();
      if (formButton) {
        formButton.click();
      }
    },
    stopGenerating: function () {
      var formButton = chatgpt.getStopGeneratingButton();
      if (formButton) {
        formButton.click();
      }
    },
  ...
  toggleScheme: function () {
    const [schemeToRemove, schemeToAdd] = document.documentElement.classList.contains("dark")
      ? ["dark", "light"]
      : ["light", "dark"];
    document.documentElement.classList.replace(schemeToRemove, schemeToAdd);
    document.documentElement.style.colorScheme = schemeToAdd;
